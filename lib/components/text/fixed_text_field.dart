...
/// Signature for the [FixedTextField.buildCounter] callback.
typedef FixedInputCounterWidgetBuilder = Widget? Function(
  /// The build context for the FixedTextField.
  BuildContext context, {
  /// The length of the string currently in the input.
  required int currentLength,

  /// The maximum string length that can be entered into the FixedTextField.
  required int? maxLength,

  /// Whether or not the FixedTextField is currently focused.  Mainly provided for
  /// the [liveRegion] parameter in the [Semantics] widget for accessibility.
  required bool isFocused,
});

class _FixedTextFieldSelectionGestureDetectorBuilder extends TextSelectionGestureDetectorBuilder {
  _FixedTextFieldSelectionGestureDetectorBuilder({
    required _FixedTextFieldState state,
  })  : _state = state,
        super(delegate: state);

  final _FixedTextFieldState _state;
...
class FixedTextField extends StatefulWidget {
  const FixedTextField({
    ...
    this.restorationId,
        ...
        assert(maxLength == null || maxLength == FixedTextField.noMaxLength || maxLength > 0),
        ...
        assert(
          ...
          'Use keyboardType TextInputType.multiline when using TextInputAction.newline on a multiline FixedTextField.',
        ),
  ...
  /// to [FixedTextField.noMaxLength] then only the current character count is displayed.
  ///
  ...
  ///
  /// This value must be either null, [FixedTextField.noMaxLength], or greater than 0.
  /// If null (the default) then there is no limit to the number of characters
  /// that can be entered. If set to [FixedTextField.noMaxLength], then no limit will
  ...
  /// {@template flutter.material.FixedTextField.onTap}
  ...
  ///
  /// See [FixedInputCounterWidgetBuilder] for an explanation of the passed in
  ...
  /// be created at all.
  final FixedInputCounterWidgetBuilder? buildCounter;
  ...
  /// {@template flutter.material.FixedTextField.restorationId}
  ...
  @override
  _FixedTextFieldState createState() => _FixedTextFieldState();
...
class _FixedTextFieldState extends State<FixedTextField> with RestorationMixin implements TextSelectionGestureDetectorBuilderDelegate {
  ...
  late _FixedTextFieldSelectionGestureDetectorBuilder _selectionGestureDetectorBuilder;
  ...
  void initState() {
    super.initState();
    _selectionGestureDetectorBuilder = _FixedTextFieldSelectionGestureDetectorBuilder(state: this);
  ...
  @override
  void didUpdateWidget(FixedTextField oldWidget) {
